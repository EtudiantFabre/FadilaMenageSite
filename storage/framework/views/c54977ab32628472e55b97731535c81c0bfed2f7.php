...
unset($__errorArgs, $__bag); ?>" name="password" required autocomplete="current-password"" placeholder="Mot de passe" aria-label="Password">
                            <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="card-footer text-center pt-0 px-lg-2 px-1">
                  <p class="mb-4 text-sm mx-auto">
                    <?php if(Route::has('password.request')): ?>
                        Mot de passe oublié ?
                        <a class="text-primary text-gradient font-weight-bold" href="<?php echo e(route('password.request')); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/fadila/Bureau/Git/FadilaMenageSite/resources/views/auth/login.blade.php ENDPATH**/ ?>