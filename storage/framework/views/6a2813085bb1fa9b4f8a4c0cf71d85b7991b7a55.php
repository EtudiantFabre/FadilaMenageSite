              ...
              <div class="collapse navbar-collapse" id="navbarCollapse">
                ...
                <?php if(Route::has('login')): ?>
                  <div class="hidden btn-toolbar fixed top-0 right-0 px-3 py-4 sm:block">
                      <a class="text-sm text-gray-900 btn btn-warning underline dark:text-gray-500" href="<?php echo e(route('clients.prospect')); ?>">Demander un service</a>
                      <?php if(auth()->guard()->check()): ?>
                          <a href="<?php echo e(url('/home')); ?>" class="text-sm text-gray-700 dark:text-gray-500 btn btn-info underline">Home</a>
                      <?php else: ?>
                          <a href="<?php echo e(route('login')); ?>" class="text-sm text-gray-700 dark:text-gray-500 btn btn-info underline">Se connecter</a>

                          <?php if(Route::has('register')): ?>
                              <a href="<?php echo e(route('register')); ?>" class="ml-4 text-sm text-gray-700 dark:text-gray-500 underline btn btn-info">S'enregistrer</a>
                          <?php endif; ?>
                      <?php endif; ?>
                  </div>
                <?php endif; ?>
              ...
              <div class="carousel-inner" id="#">
                <div class="carousel-item active">
                  ...
                  <div class="carousel-caption d-none d-md-block text-start container">
                    ...
                    <form action="<?php echo e(route('clients.prospect')); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/fadila/Bureau/Git/FadilaMenageSite/resources/views/welcome.blade.php ENDPATH**/ ?>